...
int img_rows,img_cols,templ_rows,templ_cols;
      ...
      cout << "templ_rows: "<<templ_rows<<endl;
      cout << "templ_cols: "<<templ_cols<<endl;
      imshow( argv[1],img);
      imshow( argv[2],templ);
      waitKey(0);    
...
cout<<"* Enter ROI's   x_col: "; cin>>x_col;
cout<<"* Enter ROI's   y_row : "; cin>>y_row;
